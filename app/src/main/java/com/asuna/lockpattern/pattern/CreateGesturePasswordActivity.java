...
import com.asuna.lockpattern.R;
import com.asuna.lockpattern.view.LockPatternUtils;
import com.asuna.lockpattern.view.LockPatternView;
...
public class CreateGesturePasswordActivity extends Activity implements
	...
	protected enum Stage {
		...
		HelpScreen(R.string.lockpattern_settings_help_how_to_record, LeftButtonMode.Gone, RightButtonMode.Ok, ID_EMPTY_MESSAGE, false),
